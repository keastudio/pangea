    ...
    <>
      ...
      >
        ...
        <p
          ...
          `}
        >
          The component below is referred to as an "island component". It was server-side rendered at the time this page was statically generated, with an initial value of 0. This component is hydrated on the client side, enabling the state to be updated with the buttons below.
        </p>
